              ...
              <motion.div
                ...
                className="group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-surface-100">
                  ...
                  <div className="h-48 overflow-hidden">
                    <img src="/api/files/public/f325f7281e4fb37f2576f08ff2a51ada" alt="" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" style={{ objectFit: "cover" }} />
                  </div>
                  <div className="p-8">
