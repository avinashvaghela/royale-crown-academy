            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <motion.div
                ...
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <img src={senLearnerImageUrl} alt="Young learner receiving specialist SEN support" className="w-full h-auto object-cover" />
              ...
              <motion.div
                ...
                <motion.h2 variants={fadeUp} className="font-heading text-4xl md:text-5xl font-bold text-primary mt-4 mb-6">SEN specialists who put the learner first</motion.h2>
