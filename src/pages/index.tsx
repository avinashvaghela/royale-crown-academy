      ...
      <main id="main-content" data-oid="/#o3">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-primary" aria-label="Welcome to Royale Crown Academy" data-oid="/#o4">
          <div className="absolute inset-0 z-0" data-oid="/#o5">
            <img src={heroImageUrl} alt="" className="w-full h-full object-cover" style={{ objectPosition: 'center 17%' }} data-oid="/#o6" />
            <div className="absolute inset-0 bg-gradient-to-b from-primary/60 via-primary/30 to-primary/70" data-oid="/#o7" />
          </div>
              ...
              <motion.div
                ...
                className="group relative bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-surface-100" data-oid="/#o34">
                  ...
                  <div className="h-48 overflow-hidden" data-oid="/#o35">
                    <img src={pathway.image} alt={pathway.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" data-oid="/#o36" style={{ objectFit: "cover", objectPosition: pathway.objectPosition || "center" }} />
                  </div>
