...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50" role="banner">
      {/* Top bar */}
      <div className="hidden lg:block bg-primary text-primary-foreground pt-1.5" style={{ display: "flex" }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-10 items-center justify-between gap-8 text-sm">
