    ...
    <header className="fixed top-0 left-0 right-0 z-50" role="banner" data-oid="/components/Header.tsx#o0">
          ...
          <div className="flex h-10 items-center justify-between text-sm" data-oid="/components/Header.tsx#o3">
            <div className="hidden sm:flex items-center gap-6" data-oid="/components/Header.tsx#o4">
              <a
                ...
                className="flex items-center gap-2 hover:text-accent transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded" data-oid="/components/Header.tsx#o5">
              ...
              <a
                ...
                className="hidden md:flex items-center gap-2 hover:text-accent transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-accent rounded" data-oid="/components/Header.tsx#o8">
            ...
            <div className="flex items-center gap-3 sm:gap-4 ml-auto" data-oid="/components/Header.tsx#o11">
              <Link
                to="/book-consultation"
                className="hidden md:inline-flex items-center rounded-full border border-primary-foreground/30 px-4 py-1.5 font-medium transition-colors hover:bg-primary-foreground hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-accent" data-oid="/components/Header.tsx#o12">

                Book a Consultation
              </Link>
              <Link
                to="/join-us"
                className="inline-flex items-center rounded-full bg-accent px-4 py-1.5 font-semibold text-primary transition-colors hover:bg-accent/90 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent" data-oid="/components/Header.tsx#o13">
      ...
      <div
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" data-oid="/components/Header.tsx#o15">
          <div className="flex h-24 items-center justify-between" data-oid="/components/Header.tsx#o16">
            <Link
              to="/"
              ...
              aria-label="Royale Crown Academy home" data-oid="/components/Header.tsx#o17" style={{ fontSize: "19px", lineHeight: "24.1px", width: "220px", height: "80px" }}>
              ...
              <img
                ...
                width="80"
                height="80" data-oid="/components/Header.tsx#o18" />
            ...
            <nav
              ...
              ref={dropdownRef} data-oid="/components/Header.tsx#o19">
              ...
              <div key={group.label} className="relative" data-oid="/components/Header.tsx#o20">
                ...
                <Link
                  ...
                  aria-current={isActive(group.path) ? 'page' : undefined} data-oid="/components/Header.tsx#o21">
                ...
                <button
                  ...
                  aria-haspopup="true" data-oid="/components/Header.tsx#o23">
                ...
                <div
                  ...
                  role="menu"
                  onMouseLeave={() => setOpenDropdown(null)} data-oid="/components/Header.tsx#o26">
                  ...
                  <Link
                    ...
                    role="menuitem"
                    aria-current={isActive(item.path) ? 'page' : undefined} data-oid="/components/Header.tsx#o27">
            ...
            <div className="flex items-center gap-3 lg:hidden" data-oid="/components/Header.tsx#o28">
              <Link
                to="/book-consultation"
                className="hidden sm:inline-flex items-center rounded-full bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90" data-oid="/components/Header.tsx#o29">
              ...
              <button
                ...
                aria-label={mobileOpen ? 'Close menu' : 'Open menu'} data-oid="/components/Header.tsx#o30">

                <Icon name={mobileOpen ? 'close' : 'menu'} className="h-6 w-6" data-oid="/components/Header.tsx#o31" />
              </button>
            </div>
          </div>
        </div>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label="Mobile navigation" data-oid="/components/Header.tsx#o32">

          <nav className="flex flex-col" aria-label="Mobile navigation" data-oid="/components/Header.tsx#o33">
            {navGroups.map((group) =>
          <div key={group.label} className="border-b border-neutral last:border-0" data-oid="/components/Header.tsx#o34">
                {group.items.length === 0 ?
            <Link
              to={group.path}
              ...
              aria-current={isActive(group.path) ? 'page' : undefined} data-oid="/components/Header.tsx#o35">

                    {group.label}
                    <Icon name="chevronRight" className="h-5 w-5 text-secondary" data-oid="/components/Header.tsx#o36" />
                  </Link> :
            ...
            <>
                ...
                aria-expanded={openMobileGroup === group.label} data-oid="/components/Header.tsx#o37">
              ...
              <div className="pb-3 pl-4 flex flex-col gap-1" data-oid="/components/Header.tsx#o39">
                        {group.items.map((item) =>
                <Link
                  key={item.path}
                  to={item.path}
                  ...
                  aria-current={isActive(item.path) ? 'page' : undefined} data-oid="/components/Header.tsx#o40">
            ...
            <div className="mt-6 flex flex-col gap-3" data-oid="/components/Header.tsx#o41">
              <Link
              to="/book-consultation"
              className="inline-flex items-center justify-center rounded-full bg-primary px-5 py-3 text-base font-semibold text-primary-foreground transition-colors hover:bg-primary/90" data-oid="/components/Header.tsx#o42">

                Book a Consultation
              </Link>
              <Link
              to="/join-us"
              className="inline-flex items-center justify-center rounded-full bg-accent px-5 py-3 text-base font-semibold text-primary transition-colors hover:bg-accent/90" data-oid="/components/Header.tsx#o43">
