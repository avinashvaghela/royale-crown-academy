      ...
      <div>
        <label className="flex items-start gap-3">
          ...
          <span className="text-sm text-surface-600">
            I confirm I am authorised to make this enquiry and agree to Royale Crown Academy Ltd processing these details in line with the <Link to="/privacy-policy" className="font-medium text-primary underline">Privacy Policy</Link>. <span className="text-red-500">*</span>
          </span>
        </label>
