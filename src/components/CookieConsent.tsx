            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
              <div className="flex-1">
                ...
                <p className="mt-2 max-w-3xl text-sm leading-relaxed text-surface-600">
                  We use necessary cookies to make this website work. With your consent, we may also use analytics and marketing cookies to understand how visitors use our site. You can change your preferences at any time. Read our <a href="/cookie-policy" className="font-medium text-primary underline">Cookie Policy</a>.
                </p>
              </div>
