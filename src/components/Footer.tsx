      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <Link to="/" className="inline-flex items-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C6A15B] rounded-md" style={{ fontSize: '21px', lineHeight: '24.3px', width: '130px', height: '40px' }}><img src={logoUrl} alt="Royale Crown Academy" className="h-10 w-auto object-contain" />
            ...
            <div className="mt-6 space-y-3 text-sm text-[#FAF9F6]/80">
              <p className="flex items-center gap-3">
                ...
                <a href="tel:07553539869" className="transition-colors hover:text-[#C6A15B]">07553 539869</a>
              </p>
              <p className="flex items-center gap-3">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:col-span-8 lg:grid-cols-4">
            <div>
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider text-[#C6A15B]">For Parents</h3>
            ...
            <div>
              <h3 className="font-heading text-sm font-semibold uppercase tracking-wider text-[#C6A15B]">Schools & Councils</h3>
              <ul className="mt-4 space-y-2.5">
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[#FAF9F6]/10 pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="#" className="text-[#FAF9F6]/60 transition-colors hover:text-[#C6A15B]" aria-label="Instagram">
