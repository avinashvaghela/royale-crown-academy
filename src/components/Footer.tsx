      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-4">
            <Link to="/" className="inline-flex items-center gap-3 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#C6A15B] rounded-md" style={{ fontSize: '21px', lineHeight: '24.3px', width: '130px', height: '40px' }}><img src={logoUrl} alt="Royale Crown Academy" className="h-14 w-auto object-contain" />
